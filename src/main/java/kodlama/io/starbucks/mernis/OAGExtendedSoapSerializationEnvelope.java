...
class OAGSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class OAGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(OAGDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new OAGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static OAGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static OAGDateTimeConverter dateTimeConverter = new OAGStandardDateTimeConverter();

    public OAGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public OAGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OAGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=OAGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,OAGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=OAGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
