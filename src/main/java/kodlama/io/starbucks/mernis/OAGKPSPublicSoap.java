...
public class OAGKPSPublicSoap
{
    ...
    public OAGKPSPublicSoap(){}

    public OAGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public OAGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        OAGExtendedSoapSerializationEnvelope envelope= new OAGExtendedSoapSerializationEnvelope(OAGExtendedSoapSerializationEnvelope.VER11);
